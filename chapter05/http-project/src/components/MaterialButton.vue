<template>
   <button tabindex="0" class="button" :class="{round:isRound,isFlat:isFlat}" :style="{background:backgroundColor,color:textColor}" v-on="listeners">
...
.button:not(.isFlat):active:before,
.button:not(.isFlat):hover:before{
    box-shadow:0 3px 5px -1px rgba(0,0,0,0.2),0 5px 8px rgb(0,0,0,0.14),0 1px 14px rgba(0,0,0,0.12);
}
